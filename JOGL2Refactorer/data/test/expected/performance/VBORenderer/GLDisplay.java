...
public class GLDisplay
{
    ...
    private int bufferDataUsage = GL2.GL_STATIC_DRAW;    // by default, set VBO usage to STATIC_DRAW
    ...
    {
        return createGLDisplay(appTitle, new GLCapabilities(GLProfile.get(GLProfile.GL2)));
    }
...
//        }
    ...
    private class MyGLEventListener implements GLEventListener
    {
		...
		public void dispose(GLAutoDrawable glDrawable) {
			for (int i = 0; i < eventListeners.size(); i++) {
				((GLEventListener) eventListeners.get(i)).dispose(glDrawable);
			}
		}
    }
    ...
    private class StatsPanel extends JPanel implements GLEventListener
    {
        ...
        public void init(GLAutoDrawable glDrawable)
        {
            ...
            sb.append("  Video card vender: " + gl.glGetString(GL2.GL_VENDOR) + "\n");
            sb.append("  Renderer: " + gl.glGetString(GL2.GL_RENDERER));
    ...
    private class ControlPanel extends JPanel implements ActionListener, ItemListener, GLEventListener
    {
        ...
        public ControlPanel createControlPanel(int width, int height)
        {
            ...
            if (bufferDataUsage == GL2.GL_STATIC_DRAW)
            ...
            if (bufferDataUsage == GL2.GL_DYNAMIC_DRAW)
            ...
            if (bufferDataUsage == GL2.GL_STREAM_DRAW)
