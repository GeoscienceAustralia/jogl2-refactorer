...
public class WorldWindDiagnostics
{
    private static class GLFrame extends JFrame implements GLEventListener
    {
        ...
        private static Attr[] attrs = new Attr[]
            {
                new Attr(GL2.GL_STENCIL_BITS, "stencil bits"),
                new Attr(GL2.GL_DEPTH_BITS, "depth bits"),
                new Attr(GL2.GL_MAX_TEXTURE_UNITS, "max texture units"),
                new Attr(GL2.GL_MAX_TEXTURE_IMAGE_UNITS, "max texture image units"),
                new Attr(GL2.GL_MAX_TEXTURE_COORDS, "max texture coords"),
                new Attr(GL2.GL_MAX_TEXTURE_SIZE, "max texture size"),
        ...
        public void init(GLAutoDrawable glAutoDrawable)
        {
            ...
            sb.append("\nOpenGL Values\n");
            String oglVersion = gl.glGetString(GL2.GL_VERSION);
            ...
            String extensionString = gl.glGetString(GL2.GL_EXTENSIONS);
        ...
        {
            glAutoDrawable.getGL().getGL2().glClear(GL2.GL_COLOR_BUFFER_BIT | GL2.GL_DEPTH_BUFFER_BIT);
