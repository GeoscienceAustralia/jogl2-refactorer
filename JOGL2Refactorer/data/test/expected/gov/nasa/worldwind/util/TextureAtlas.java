...
public class TextureAtlas
{
    ...
    protected class AtlasBackingStore implements BackingStoreManager
    {
        ...
        {
            return !isEvictOldElements() || !removeLeastRecentlyUsedEntry();
        }
    ...
    {
        BufferedImage backingImage = (BufferedImage) this.rectPacker.getBackingStore();
        Texture texture = AWTTextureIO.newTexture(GLProfile.get(GLProfile.GL2), backingImage, this.isUseMipMaps());
    ...
    protected Texture updateTextureWithSubImage(DrawContext dc, Rectangle rect)
    {
        ...
        if (!this.isUseMipMaps() || texture.isUsingAutoMipmapGeneration())
        {
            ...
            TextureData subTextureData = AWTTextureIO.newTextureData(GLProfile.get(GLProfile.GL2), subImage, false); // No need for sub-image mip-maps.
        ...
        else
        {
            ...
            // default values.
            BufferedImage backingImage = (BufferedImage) this.rectPacker.getBackingStore();
            texture.updateImage(dc.getGL(), AWTTextureIO.newTextureData(GLProfile.get(GLProfile.GL2), backingImage, this.isUseMipMaps()));
            this.setTextureParameters(dc);
        }
