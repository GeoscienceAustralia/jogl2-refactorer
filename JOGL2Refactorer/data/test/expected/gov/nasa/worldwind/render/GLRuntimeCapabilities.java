...
public class GLRuntimeCapabilities
{
    ...
    public void initialize(GLContext glContext)
    {
        ...
        {
            String s = gl.glGetString(GL2.GL_VERSION);
            if (s != null)
            {
                s = s.substring(0, 3);
        ...
        if (this.maxTextureAnisotropy < 0)
        {
            ...
            if (this.isAnisotropicTextureFilterAvailable)
            {
                ...
                glContext.getGL().getGL2().glGetDoublev(GL2.GL_MAX_TEXTURE_MAX_ANISOTROPY_EXT, params, 0);
        ...
        {
            int[] params = new int[1];
            gl.glGetIntegerv(GL2.GL_MAX_TEXTURE_SIZE, params, 0);
