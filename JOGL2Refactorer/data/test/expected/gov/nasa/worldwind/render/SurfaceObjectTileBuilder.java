...
public class SurfaceObjectTileBuilder
{
    ...
    protected static final int DEFAULT_TEXTURE_INTERNAL_FORMAT = GL2.GL_RGBA8;
    /** The default OpenGL pixel format used to create surface tile textures. */
    protected static final int DEFAULT_TEXTURE_PIXEL_FORMAT = GL2.GL_RGBA;
    /**
    ...
    protected void updateTiles(DrawContext dc)
    {
        ...
        this.rttSupport.setEnableFramebufferObject(
            this.tileTextureFormat == 0 || // Default format is GL_RGB8.
                this.tileTextureFormat == GL2.GL_RGB ||
                this.tileTextureFormat == GL2.GL_RGB8 ||
                this.tileTextureFormat == GL2.GL_RGBA ||
                this.tileTextureFormat == GL2.GL_RGBA8);
    ...
    protected Texture createTileTexture(DrawContext dc, int width, int height)
    {
        ...
        TextureData td = new TextureData(
            GLProfile.get(GLProfile.GL2), internalFormat,       // internal format
        ...
        gl.glTexParameteri(GL2.GL_TEXTURE_2D, GL2.GL_TEXTURE_MIN_FILTER, this.isUseLinearFilter() ?
            (this.isUseMipmaps() ? GL2.GL_LINEAR_MIPMAP_LINEAR : GL2.GL_LINEAR) : GL2.GL_NEAREST);
        gl.glTexParameteri(GL2.GL_TEXTURE_2D, GL2.GL_TEXTURE_MAG_FILTER, this.isUseLinearFilter() ?
