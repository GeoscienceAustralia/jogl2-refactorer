...
/**
 * @author Tom Gaskins
 * @version $Id: DrawContextImpl.java 704 2012-07-21 03:16:21Z tgaskins $
 */
public class DrawContextImpl extends WWObjectImpl implements DrawContext
{
    ...
    public int getPickColorAtPoint(Point point)
    {
        ...
        this.getGL().glReadPixels(x, y, 1, 1, GL2.GL_RGB, GL2.GL_UNSIGNED_BYTE, this.pixelColors);
    ...
    public int[] getPickColorsInRectangle(Rectangle rectangle, int[] minAndMaxColorCodes)
    {
        ...
        gl.glGetIntegerv(GL2.GL_PACK_ALIGNMENT, packAlignment, 0);
        try
        {
            ...
            gl.glReadPixels(r.x, r.y, r.width, r.height, GL2.GL_RGB, GL2.GL_UNSIGNED_BYTE, this.pixelColors);
        }
        finally
        {
            // Restore the previous GL pack alignment state.
            gl.glPixelStorei(GL2.GL_PACK_ALIGNMENT, packAlignment[0]);
        }
    ...
    {
        this.getGL().glBlendFunc(GL2.GL_ONE, GL2.GL_ZERO);
        this.getGL().glDisable(GL2.GL_BLEND);
    }
    ...
    {
        this.getGL().glEnable(GL2.GL_DEPTH_TEST);
